...
UPDATE sakila.actor
SET first_name = 'JULES' -- nome atualizado
WHERE first_name = 'JULIA'; -- nome que foi substituido
...
-- 4) Foi determinado pelo setor financeiro que haverá um reajuste em todos os preços dos filmes, com base em sua duração. Para todos os filmes com duração entre 0 e 100, o valor do aluguel 
