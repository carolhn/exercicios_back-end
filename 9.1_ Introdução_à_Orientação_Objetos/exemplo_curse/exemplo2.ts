class Person {
    ...
    private _age: number;
    readonly height: number; //atributo pode ser visto porem nao pode ser alterado (so leitura) 
  ...
  // get serve para ler os atributos
    get age() {
      return this._age;
    }
  ...
  // set serve para modificar o atributo
